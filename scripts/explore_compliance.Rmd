...
summary_compliance <- summary_compliance %>%
  mutate(respondent_type = ifelse(temperature == "Humans", "Humans", "GPT-4o"),
         temperature = ifelse(temperature == "Humans", "NA", temperature))
...
compliance_by_temp <- ggplot(
  ...
  facet_grid(~ respondent_type, scales = "free_x", space = "free_x")
